...
class BG3Settings(settings.Group):
    class RootDirectory(settings.UserFolderPath):
        ...
        This is used by the BG3 client so it knows where to send communication files.
        """
