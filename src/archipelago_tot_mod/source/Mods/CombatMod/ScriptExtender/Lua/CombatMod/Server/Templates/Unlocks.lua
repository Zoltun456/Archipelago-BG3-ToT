...
local multis = {
    {
        Id = "MOD_BOOSTS",
        Name = TL("h2cd8cf00g798dg49a5g91fegbfc333dc9de1"),
    ...
    {
        Id = "ExpMultiplier",
        Name = TL("h294ce46eg7c19g4b13gb1a7gfd75d385df57"),
        Icon = "Spell_MagicJar",
        Cost = 100,
        Amount = 1,
        Character = false,
    ...
    {
        Id = "LootMultiplier",
        Name = TL("h972818a9gc27dg44dfg8a41gb2b9a863909b"),
    ...
    },
    {
        ...
        Name = TL("hce43e6c9g9b16g4b39g8fd7g0d5fadf52f7d"),
...
local ngPlus = {
    {
        Id = "QUICKSTART",
        Name = TL("h2cc2c959g7997g49c0g81ffg1fa6a3dd3d84"),
		Description = TL("hb3c9920ege69cg4c75gb80fgaa13da2d8831"),
    ...
    {
        Id = "NG MOD_BOOSTS",
        Name = TL("he27b6a7bgb72eg43f2gad14g85948f36a7b6"),
        Icon = "PassiveFeature_Generic_Explosion",
        Cost = 0,
        Amount = 1,
        Character = false,
    ...
    {
        Id = "BuyRogueScore",
        Name = TL("hc60d0ebbg9358g45begaf53ge3d88d71c1fa", "+50"),
		Description = TL("hd854417eg8d01g4142gbeb6g7724dc945506"),
    ...
    {
        Id = "ScoreMultiplier",
        Name = TL("h4b49f453g1e1cg4a10ga787gac7605a58e54"),
        Icon = "GenericIcon_Intent_Buff",
        Cost = 0,
        Amount = 1,
        Character = false,
    ...
    {
        Id = "BuyLootPlus",
        Name = TL("hee9d3983gbbc8g46cdgaddage0ab0ff8c289", 10),
    ...
    {
        Id = "BuyStockPlus",
        Name = TL("h360818b2g635dg44degb053gb2b81271909a"),
        Icon = "Item_BOOK_SignedTradeVisa",
        Description = TL("h6256c771g3703g4922g8516g5f4427347d66"),
        Cost = 1000,
        Amount = nil,
        Requirement = { "QUICKSTART" },
        Character = false,
...
return table.extend({
    {
        Id = "UnlockTadpole",
        Name = TL("hb00c97b7ge559g4c2ega833gfa484a11d86a"),
    ...
    {
        Id = "TadpoleCeremorph",
        Name = TL("h9f1540b5gca40g415eg8ac2g673868e0451a"),
        Icon = "TadpoleSuperPower_IllithidPersuasion",
        Description = TL("h2544d6fag7011g483agb167g7e5c93455c7e", TL("hb00c97b7ge559g4c2ega833gfa484a11d86a")),
        Cost = 300,
        Amount = nil,
        Character = true,
        Requirement = 45,
    ...
    },
    {
        ...
        Description = TL("h806c6e82gd539g43bdgbb35gf5db1917d7f9"),
        Requirement = 150,
        Cost = 1200,
        Amount = 1,
        Character = true,
    ...
    {
        Id = "TadAwaken",
        Name = TL("hf34df053ga618g4a50gac07gec360e25ce14"),
        Icon = "PassiveFeature_CRE_GithInfirmary_Awakened",
        Description = TL("he7764179gb223g4142g8d44g5724af667506"),
        Cost = 100,
        Requirement = 50,
        Amount = 1,
        Character = true,
    ...
    {
        Id = "BuyEmperor",
        Name = TL("hc6c558ccg9390g40d9g9f5fg66bffd7d449d"),
        Description = TL("hd9746d3ag8c21g4386gbea4g75e09c8657c2"),
    ...
    {
        Id = "BuyNightsong",
        Name = TL("hcf08bac4g9a5dg4ef9g9fc3gb89f7de19abd"),
        Description = TL("h3cd7cd32g6982g4986gb0feg4fe012dc6dc2"),
    ...
    {
        Id = "BuyOwlbear",
        Name = TL("hb2385d5age76dg4080gb810gb6e69a3294c4"),
        Description = TL("hcff9583bg9aacg40d6gafccga6b08dee8492"),
    ...
    {
        Id = "Tadpole",
        Name = TL("h36f8f1b6g63adg4a4egb05cgbc28527e9e0a"),
    ...
    {
        Id = "BuyLoot",
        Name = TL("h3b8839f6g6eddg46cagb08bgb0ac52a9928e", 10),
    ...
    {
        Id = "BuyLootRare",
        Name = TL("h3d445f63g6811g40a3ga0e7g76c502c554e7", 5),
    ...
    {
        Id = "BuyLootEpic",
        Name = TL("h3f24d43fg6a71g4816ga0c1g7e70c2e35c52", 3),
        Icon = "Item_CONT_GEN_Chest_Jewel_A",
        Cost = 100,
        Requirement = 50,
        Amount = 3,
    ...
    {
        Id = "BuyLootLegendary",
        Name = TL("hc2dd2983g9788g47cdgaf1ege1ab0d3cc389", 1),
    ...
    {
        Id = "BuySupplies",
        Name = TL("hab83587fgfed6g40d2ga98bg06b4cba92496"),
    ...
    },
    {
       ...
       Description = TL("h0f1c219ag5a49g474cgb3c2gf12a91e0d308"),
...
--    {
--         Id = "BuyRestore",
--         Name = TL("hfea436e8gabf1g463bg9cd9g705dbefb527f"),
--         Icon = "Action_EndGame_IsobelHeal",
--         Description = TL("h23173fb5g7642g46aeg8102g40c8632062ea"),
--         Cost = 20,
--         Amount = nil,
--         Character = true,
--         OnBuy = function(self, character)
...
--    },
    {
        Id = "Moonshield",
        Name = TL("h27f7bcfeg72a2g4e9agb14cg48fcd36e6ade"),
        Description = TL("h2e6a96f6g7b3fg4c3agb1d5g9a5c53f7b87e"),
    ...
    {
        Id = "BreakOath",
        Name = TL("h337385c4g6626g4d09g9004g0b6f7226294d"),
        Icon = "statIcons_OathBroken",
        Description = TL("had299379gf87cg4c62g89e1gaa04abc38826"),
        Cost = 10,
        Amount = nil,
        Character = true,
        OnBuy = function(self, character)
    ...
    },
    {
        ...
        Description = TL("h3450ea1cg6105g4bf4g9076g3d92f2541fb0"),
        Cost = 120,
        Requirement = 50,
        Amount = 1,
        Character = true,
    ...
    },
    {
        ...
        Description = TL("hc38ac208g96dfg4975g9f0bg9f13bd29bd31"),
        Cost = 20,
        Amount = 2,
        Character = true,
        OnBuy = function(self, character)
    ...
    },
    {
        ...
        Description = TL("h0a776a90g5f22g43fcg9394g459a31b667b8"),
        Cost = 400,
        Requirement = 150,
        Amount = 1,
        Character = true,
    ...
    },
    {
        ...
        Description = TL("h7e986d9bg2bcdg438cga4dagb5ea86f897c8"),
        Cost = 275,
        Requirement = 150,
        Amount = 1,
        Character = true,
    ...
    },
    {
        ...
        Description = TL("h41328a2ag1467g4df7gb720g1b91950239b3"),
        Cost = 350,
        Requirement = 150,
        Amount = 1,
        Character = true,
    ...
    },
    {
        ...
        Description = TL("h97709a29gc225g4cf7g8a44g3a91a86618b3"),
        Cost = 350,
        Requirement = 150,
        Amount = 1,
        Character = true,
