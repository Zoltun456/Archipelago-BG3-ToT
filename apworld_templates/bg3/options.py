...
class SyncMethod(Choice):
    """
    Determines when pending Archipelago items are applied in BG3.

    Scroll Tav: Use the Archipelago sync action manually.
    Any Action Tav: Apply pending items automatically during regular camp or Trials interaction.
    """
